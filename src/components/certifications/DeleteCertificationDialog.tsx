    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex w-[420px] flex-col gap-4 p-5">
        ...
        <div className="flex flex-col gap-1.5">
          <DialogTitle className="text-base">Delete this certification?</DialogTitle>
          <DialogDescription>
            This will remove &ldquo;{certificationName}&rdquo; from your Certifications. This can&rsquo;t be undone.
          </DialogDescription>
        </div>
